	...
	LDA update_screen
	AnD #%10000000
	BNE doUpdateHudElementAsset
	RTS
doUpdateHudElementAsset:
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	LDA updateHUD_active
	AND #%10000000
	BEQ ++
	AssignHudLabel #BOX_0_ASSET_0_IMAGE
	JMP +++
++
	LDA updateHUD_active
	AND #%01000000
	BEQ ++
	AssignHudLabel #BOX_0_ASSET_1_IMAGE
	JMP +++
++
	LDA updateHUD_active
	AND #%00100000
	...
	AssignHudLabel #BOX_0_ASSET_2_IMAGE
	JMP +++
++
	...
	AssignHudLabel #BOX_0_ASSET_3_IMAGE
	JMP +++
++
	...
	AssignHudLabel #BOX_0_ASSET_4_IMAGE
	JMP +++
++
	...
	AssignHudLabel #BOX_0_ASSET_5_IMAGE
	JMP +++
++
	...
	AssignHudLabel #BOX_0_ASSET_6_IMAGE
	JMP +++
++
	...
	AssignHudLabel #BOX_0_ASSET_7_IMAGE
	JMP +++
++
...
DoHudElementAssetDirectLoop:
	...
	STA hudTileCounter
	JMP DoHudElementAssetDirectLoop
dontSkipLineInHudImageOrText:
	
	CMP #$FF
	BEQ doneWithHudElementAssetDirect
writeThisValue:
	CLC
	ADC #HUD_TILES_START
